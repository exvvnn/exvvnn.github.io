    ...
    app.innerHTML = `
        <header class="site-header">
            ...
            <nav class="site-nav" aria-label="Main navigation">
                ...
                <a class="nav-contact" href="mailto:hello@exvvnn.dev">Let's talk <span aria-hidden="true">&nearr;</span></a>
            </nav>
        </header>
        <main id="top">
            <section class="hero" aria-labelledby="hero-title">
                <div class="hero-copy">
                    ...
                    <div class="hero-actions"><a class="button button-primary" href="#work">See what I make <span aria-hidden="true">&darr;</span></a><a class="text-link" href="mailto:hello@exvvnn.dev">Start a conversation <span aria-hidden="true">&nearr;</span></a></div>
                </div>
            ...
            <section class="contact-section" id="contact" aria-labelledby="contact-title"><p class="eyebrow">Have a good one?</p><h2 id="contact-title">Let's make<br><em>something memorable.</em></h2><a class="contact-link" href="mailto:hello@exvvnn.dev">hello@exvvnn.dev <span aria-hidden="true">&nearr;</span></a></section>
        </main>
